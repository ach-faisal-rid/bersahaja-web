...
const form = useForm({
    waktu: props.iqamat.waktu,
    teks_arab: props.iqamat.teks_arab,
    transliterasi: props.iqamat.transliterasi,
    terjemahan: props.iqamat.terjemahan,
});

const submit = () => {
    form.put(`/iqamat/${props.iqamat.id}`);
};
</script>

<template>
    <Head title="Edit Iqamat" />
        ...
        <div class="space-y-6">
            <div class="flex items-center justify-between">
                <p class="text-sm text-gray-600 dark:text-gray-300">
                    Edit teks iqamat untuk waktu sholat {{ iqamat.waktu }}.
                </p>
                <Link href="/iqamat">
