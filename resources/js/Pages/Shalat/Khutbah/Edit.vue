...
const form = useForm({
    judul: props.khutbah.judul,
    teks_arab: props.khutbah.teks_arab,
    transliterasi: props.khutbah.transliterasi,
    terjemahan: props.khutbah.terjemahan,
});

const submit = () => {
    form.put(`/khutbah/${props.khutbah.id}`);
};
</script>

<template>
    <Head title="Edit Khutbah" />
