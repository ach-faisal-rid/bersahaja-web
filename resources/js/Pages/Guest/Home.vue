...
const shalatModules = [
  ...
  },
  {
    id: 'adzan',
    title: 'Adzan',
    description: 'Teks adzan lengkap untuk setiap waktu sholat.',
    href: '/adzan',
    badge: 'Adzan',
  },
  {
    id: 'iqamat',
    title: 'Iqamat',
    description: 'Teks iqamat untuk memulai sholat berjamaah.',
    href: '/iqamat',
    badge: 'Iqamat',
  },
  {
    id: 'khutbah',
    title: 'Khutbah',
    description: 'Khutbah Jumat dan nasihat keagamaan.',
    href: '/khutbah',
    badge: 'Khutbah',
  },
  {
    ...
    description: 'Kumpulan doa yang dibaca setelah sholat.',
